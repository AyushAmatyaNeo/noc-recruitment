...
--truncate table hris_rec_vacanc y_inclusion;

ALTER TABLE HRIS_REC_USERS_ADDRESS ADD(PER_HOUSE_NO VARCHAR (20));
ALTER TABLE HRIS_REC_USERS_ADDRESS ADD(MAIL_HOUSE_NO VARCHAR (20));