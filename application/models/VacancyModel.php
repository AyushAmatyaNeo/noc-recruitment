...
class VacancyModel extends CI_Model
{
    ...
    public function fetchvacancy()
    {
        ...
        DEPARTMENT_NAME,FILE_IN_DIR_NAME,FUNCTIONAL_LEVEL_EDESC,SERVICE_TYPE_NAME,
        SERVICE_EVENT_NAME,START_DATE,END_DATE,EXTENDED_DATE,
               INCLUSION_ID,STAGE_EDESC,FILE_NAME  FROM (
           SELECT 
               HRO.OPENING_ID,
               case 
                   when right(left(AD_NO,2),1)='/'
        ...
        DEPARTMENT_NAME,FILE_IN_DIR_NAME,FUNCTIONAL_LEVEL_EDESC,SERVICE_TYPE_NAME,
        SERVICE_EVENT_NAME,START_DATE,END_DATE,EXTENDED_DATE,
               INCLUSION_ID,STAGE_EDESC,FILE_NAME
