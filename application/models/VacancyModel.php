...
class VacancyModel extends CI_Model
{
    ...
    public function fetchvacancy()
    {
        ...
        $query  = $this->db->query("SELECT NV.VACANCY_ID,AD_NO,DESIGNATION_TITLE,DESIGNATION_ID,NV.STATUS,NV.VACANCY_RESERVATION_NO,DEPARTMENT_NAME,FILE_IN_DIR_NAME,FUNCTIONAL_LEVEL_EDESC,SERVICE_TYPE_NAME,SERVICE_EVENT_NAME,START_DATE,END_DATE,EXTENDED_DATE,NV.INCLUSION_ID,STAGE_EDESC,FILE_NAME FROM $this->table NV 
    ...
    {
        $query = $this->db->query("SELECT NV.VACANCY_ID,NV.INCLUSION_ID,AD_NO,DESIGNATION_TITLE,DESIGNATION_ID,NV.STATUS,DEPARTMENT_NAME,FUNCTIONAL_LEVEL_EDESC,FUNCTIONAL_LEVEL_ID,INSTRUCTION_EDESC,ACADEMIC_DEGREE_CODE,ACADEMIC_DEGREE_NAME,SKILL_ID,EXPERIENCE FROM $this->table NV 
        LEFT JOIN HRIS_DESIGNATIONS HD ON NV.POSITION_ID = HD.DESIGNATION_ID
        LEFT JOIN HRIS_DEPARTMENTS HVD ON NV.DEPARTMENT_ID = HVD.DEPARTMENT_ID
        LEFT JOIN HRIS_FUNCTIONAL_LEVELS  HFL ON HFL.FUNCTIONAL_LEVEL_ID = NV.LEVEL_ID
