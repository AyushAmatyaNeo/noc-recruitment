...
|
*/
$config['base_url'] = 'https://erecruitment.nepaloil.org.np/';
// $config['base_url'] = 'http://localhost/noc-recruitment/';
// $config['base_url'] = 'http://localhost/GIT-NOC/noc-recuitment/noc-recruitment/';
