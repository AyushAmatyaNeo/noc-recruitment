					...
					<div class="left-form p-5">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								...
								<input class="form-control btn-input" placeholder="Employment Status" type="text" name="employment_input" id="employment_input" value="<?php echo $user['EMPLOYMENT_INPUT']; ?>" style='display:none;' />
							</div>
						...
						<div class="form-row">
							...
							<div class=" form-group col-md-3">
								...
								<select class="form-control" name="ctz_issue_district_id">
									<!-- <option value="<?php //echo $user['DISTRICT_ID'] 
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								...
								<input class="form-control btn-input form-control-file" type="file" name="disability_file" id="disability_file" style='display:none;' />
								<?php
								if (!empty($documents)) {
