								...
								<form method="post">
									...
									<div class="form-row ">
										...
										<div class="form-group col-md-12 cstm-form-grp">
											...
											<input type="text" name="MOBILE_NO" class="form-control" id="inputMobile" placeholder="Mobile No (NTC/Ncell)" value="<?php echo !empty($user['MOBILE_NO'])?$user['MOBILE_NO']:''; ?>" required>
										...
										<div class="form-group col-md-12">
											<div class="confirm-red d-md-flex d-sm-block">
												<div class="confirm1" style="margin-right: 10px;">
													...
													<span style="color: red; padding-top: 10px; font-size: 10px;">Capital Letter</span>
												</div>
												<div class="confirm2" style="margin-right: 10px;">
													<i class="fa fa-exclamation-triangle" aria-hidden="true" style="color: red;font-size: 10px;"></i>
													<span style="color: red; padding-top: 10px; font-size: 10px;">Symbol</span>
												</div>
												<div class="confirm3" style="margin-right: 10px;">
													<i class="fa fa-exclamation-triangle" aria-hidden="true" style="color: red;font-size: 10px;"></i>
													<span style="color: red; padding-top: 10px; font-size: 10px;">Number</span>
												</div>
												<div class="confirm4" style="margin-right: 10px;">
													<i class="fa fa-exclamation-triangle" aria-hidden="true" style="color: red;font-size: 10px;"></i>
													<span style="color: red; padding-top: 10px; font-size: 10px;">6 Characters</span>
												</div>
												<div class="confirm4" style="margin-right: 10px;">
													<i class="fa fa-exclamation-triangle" aria-hidden="true" style="color: red;font-size: 10px;"></i>
