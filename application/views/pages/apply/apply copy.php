			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						...
						<form>
							<?php foreach ($vacancylists as $vacancylist) { ?>
								<div class="row card-body collapse" id="vacancyDetail">
									<div class="col-lg-6">
										<table class="table table-lg-responsive">
											<tr>
												<th><label class="col-form-label">Advertisement No.</label></th>
												<td>
													<input type="text" name="vacancy_id" readonly class="form-control form-control-sm" value="<?php echo $vacancylist['AD_NO']; ?>">
												</td>
											</tr>
											<tr>
												<th><label class="col-form-label"></label>Registration No.</th>
												<td><input type="text" name="registration_no" readonly class="form-control form-control-sm" value="<?php echo $vacancylist['AD_NO'] . "-" . $vacancylist['maxregId']; ?>"></td>
											</tr>
											<tr>
									...
									<div class="col-lg-6">
										<table class="table table-lg-responsive">
											...
											<tr>
												...
												<td><input type="text" readonly class="form-control form-control-sm" value="<?php echo $vacancylist['FUNCTIONAL_LEVEL_EDESC']; ?>"></td>
											</tr>
									...
									<div class="col-lg-12">
										<table>
											<tr>
												...
												<td class="col-lg-6"><textarea name="message" readonly class="form-control form-control-sm" rows="4">मान्यता प्राप्त विश्वविद्यालयबाट अर्थशास्त्र, कानून, ब्यवस्थापन, सूचना प्रविधि विषयमा प्रथम श्रेष्णीमा स्नातकोत्तर तह उत्तिर्ण भई र नेपाल राष्ट्र बैंकबाट "क" वर्गको ईजाजत प्राप्त बैक तथा वित्तीय संस्थामा अधिकृत स्तरको पदमा कम्तिमा ७ बर्षको कार्य अनुभव भएको। मान्यता प्राप्त विश्वविद्यालयबाट अर्थशास्त्र, कानून, ब्यवस्थापन, सूचना प्रविधि विषयमा प्रथम श्रेष्णीमा स्नातकोत्तर तह उत्तिर्ण भई र नेपाल राष्ट्र बैंकबाट "क" वर्गको ईजाजत प्राप्त बैक तथा वित्तीय संस्थामा अधिकृत स्तरको पदमा कम्तिमा ७ बर्षको कार्य अनुभव भएको</textarea>
											</tr>
										</table>
									</div>
								</div>
...
<script type="text/javascript">
	...
	function fileValidation($id) {
		...
		if (!allowedExtensions.exec(filePath)) {
			alert('Invalid file type, please select JPG|PNG|JPEG');
			fileInput.value = '';
			return false;
		} else {
			// Image preview
...
<script type='text/javascript' src='<?php echo base_url('assets/js/applytab.js'); ?>'></script>
